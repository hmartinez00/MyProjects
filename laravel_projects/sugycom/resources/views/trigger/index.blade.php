            ...
            <tbody>
                @forelse ($directories as $data_item)
                    @if ( $data_item !== '.' && $data_item !== '..' && $data_item !== 'data' && $data_item !== 'backup' && strpos($data_item, '.zip') === false )
                        ...
                        <tr><td><a class="nav-link text-white" data-bs-toggle="offcanvas" href="#{{ $data_item }}">{{ $data_item }}</a></td></tr>
                        
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="{{ $data_item }}">
