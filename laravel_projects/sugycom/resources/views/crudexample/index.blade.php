        ...
        {{-- <div class='row'>
            ...
            <div class="col-sm-4 col-md-4">
                ...
                <nav aria-label="...">
                    <ul class="pagination">
                        <li class="page-item disabled">
                            <a class="page-link" href="{{ route($actions . '.previus') }}">Previous</a>
                        </li>

                        <li class="page-item"><a class="page-link" href="#">1</a></li>
                        <li class="page-item active" aria-current="page">
                            <a class="page-link" href="{{ route($actions . '.show_rows', ['param' => '2']) }}">2</a>
                        </li>
                        <li class="page-item"><a class="page-link" href="#">3</a></li>
                        
                        <li class="page-item">
                            <a class="page-link" href="{{ route($actions . '.next') }}">Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
